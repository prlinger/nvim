...
plugins = {
	...
	},
	{
		...
		config = function()
			...
			configs.setup({
				ensure_installed = { "c", "lua", "vim", "vimdoc", "typescript", "javascript", "html", "python", "rust" },
				ignore_install = {},
				modules = {},
				sync_install = false,
				auto_install = true,
	...
	},
	{
		...
		-- Note, I copied the following from https://github.com/nvim-lua/kickstart.nvim.
		dependencies = {
		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					--["<C-y>"] = cmp.mapping.confirm({ select = true }), -- This was the original.
					["<Tab>"] = cmp.mapping.confirm({ select = true }), -- this is my mapping.
...
-- Rust language server. Requires installation of rust_analyzer (e.g. with brew).
